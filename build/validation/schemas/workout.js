...
exports.createWorkoutPlanValidationSchema = void 0;
var yup = __importStar(require("yup"));
var common_1 = require("./../../types/common");
var regex_1 = require("./../../constants/regex");
exports.createWorkoutPlanValidationSchema = yup.object({
    ...
    level: yup
        .mixed()
        .oneOf([common_1.LEVEL.NEWBIE, common_1.LEVEL.EXPERIENCED, common_1.LEVEL.ADVANCED])
        .required(),
    ...
    workouts: yup
        ...
        .array()
        .of(yup.object().shape({
        exercise: yup.string().matches(regex_1.objectIdRegex).required(),
