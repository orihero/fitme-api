...
var WorkoutPlanController = /** @class */ (function () {
    function WorkoutPlanController() {
    }
    WorkoutPlanController.prototype.find = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, services_1.WorkoutPlanService.findAll(req)];
                    case 1:
                        result = _a.sent();
    ...
    WorkoutPlanController.prototype.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var created, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, services_1.WorkoutPlanService.create(req.body)];
                    case 1:
                        created = _a.sent();
    ...
    WorkoutPlanController.prototype.findOne = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var found, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, services_1.WorkoutPlanService.find({ _id: req.params.id })];
                    case 1:
                        found = _a.sent();
                        if (!found) {
    ...
    WorkoutPlanController.prototype.update = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    WorkoutPlanController.prototype.delete = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, services_1.WorkoutPlanService.delete(req.params.id)];
                    case 1:
                        _a.sent();
